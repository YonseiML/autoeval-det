...
def single_gpu_test_domain_gap(model,
    ...
    for i, data in enumerate(data_loader):
        ...
        if model.module.__class__.__name__ == 'RetinaNet':
            ...
            post_nms_cls_score = model.module.bbox_head.post_nms_cls_score_value  
            ...
            post_nms_cls_score = model.module.roi_head.bbox_head.post_nms_cls_score_value  
...
def single_gpu_test(model,
    ...
    results_cls_per_dataset_ori = []
    results_cls_per_img_ori = [[] for i in range(len(data_loader.dataset))]
    result_iou_all = [[] for i in range(len(data_loader.dataset))]
    result_init_boxes = [[] for i in range(len(data_loader.dataset))]
    ...
    for i, data in enumerate(data_loader):
        ...
        if model.module.__class__.__name__ == 'RetinaNet':
            ...
            post_nms_det_bbox = model.module.bbox_head.post_nms_det_bbox_value
            pre_nms_cls_score = model.module.bbox_head.pre_nms_cls_score_value
            iou_all = model.module.bbox_head.iou_all_values
            init_boxes = model.module.bbox_head.init_boxes
            try:
                ...
                results_cls_per_dataset_ori.extend(pre_nms_cls_score[0].cpu().numpy())
                results_cls_per_img_ori[i].extend(pre_nms_cls_score[0].cpu().numpy())
                result_iou_all[i].extend(iou_all[0].cpu().numpy())
                result_init_boxes[i].extend(init_boxes[0].cpu().numpy())

            except:
                print("no detect")

        if model.module.__class__.__name__ == 'FasterRCNN':
            post_nms_cls_score = model.module.roi_head.bbox_head.post_nms_cls_score_value  
            post_nms_det_bbox = model.module.roi_head.bbox_head.post_nms_det_bbox_value
            pre_nms_cls_score = model.module.roi_head.bbox_head.pre_nms_cls_score_value
            iou_all = model.module.roi_head.bbox_head.iou_all_values
            init_boxes = model.module.roi_head.bbox_head.init_boxes
    ...
    return results, results_cls_per_dataset, results_bbox_per_dataset, results_cls_per_img, results_bbox_per_img, results_cls_per_dataset_ori, results_cls_per_img_ori, result_iou_all, result_init_boxes
