...
def draw_boxes(image, green_box=None, yellow_boxes=None, red_box=None):
    # 빈 이미지 생성
...
def apply_iou_filter(scores: torch.Tensor,
    ...
    for i in range(num_boxes):
        ...
        if removed_box.numel() != 0:  # # removed_box가 비어 있지 않을 때 처리
            ...
            # image = draw_boxes(image, green_box=ref_box, yellow_boxes=removed_box)
