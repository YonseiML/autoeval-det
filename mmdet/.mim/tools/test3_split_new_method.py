...
def main():
    ...
    for area_idx, area in enumerate(areaRng):
        ...
        for img_idx in range(len(results_bbox_per_img)):
            ...
            if len(iou_all) > 0 :
                ...
                keep, pseudo_ious, dist = apply_iou_filter(score_all, iou_all, 0.5, init_box)
                ...
                conf_up = conf > 0.5
                conf_down = conf <= 0.5
                iou_up_ref = pseudo_ious > 0.5
                iou_down_ref = pseudo_ious <= 0.5
    ...
    if rank == 0:
        ...
        if len(outputs) >= 4:
            ...
            NAME_DIR  = "./res_split_new_method_no_adj/" + str(args.tag1)
