...
def main():
    ...
    for area_idx, area in enumerate(areaRng):
        ...
        for img_idx in range(len(results_bbox_per_img)):
            ...
            if len(iou_all) > 0 :
                ...
                conf_up = conf > 0.5
                conf_down = conf <= 0.5
                iou_up = pseudo_ious > 3   #5
                iou_down = pseudo_ious <= 3
                iou_up2 = pseudo_ious > 2  #4
                iou_down2 = pseudo_ious <= 2
                # conf_up = conf > 0.5
                # conf_down = conf <= 0.5
    ...
    if rank == 0:
        ...
        if len(outputs) >= 4:
            ...
            NAME_DIR  = "./res_split_distance_3&2/" + str(args.tag1)
