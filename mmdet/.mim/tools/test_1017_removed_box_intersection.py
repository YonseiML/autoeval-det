...
def apply_iou_filter(scores: torch.Tensor,
    ...
    return keep, score7, score8, score9, nothing
...
def main():
    ...
    for area_idx, area in enumerate(areaRng):
        ...
        for img_idx in range(len(results_bbox_per_img)):
            ...
            if len(iou_all) > 0 :
                ...
                keep, score7, score8, score9, nothing = apply_iou_filter(score_all, iou_all, 0.5, init_box)
    ...
    if rank == 0:
        ...
        if len(outputs) >= 4:
            ...
            NAME_DIR  = "./res_1017_new_ablation/" + str(args.tag1)
