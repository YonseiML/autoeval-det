...
# sources = ["bdd", "detrac", "exdark", "kitti", "self_driving2coco", "roboflow2coco", "udacity2coco", "traffic2coco"]
...
#     for source in sources:
#         for meta in range(metesize):
#             with open('./res_multiweather_train_60_model_2/' + str(expert) + '_expert/cost_droprate_' + dropou_rate + '_' + str(source) + '_droppos_' + dropout_pos + '/' + str(meta+1) + '.json') as f:
#                 data = json.load(f)        
#                 X.append(data['0'][0][0]*100) # mAP
#                 # y.append(-data['0'][2][0])
#                 y.append(data['0'][8][0])
...
# print(y)
# exit()
# sources = ["bdd", "cityscapes"]
# sources = ["bdd", "cityscapes", "detrac", "exdark", "kitti", "self_driving2coco", "traffic2coco"]
# sources = ["cityscapes"]
...
for source in sources:
    for meta in range(metesize):
        # meta = meta+11
        with open('./02.23/ablation_conf_thr0.5_swin_faster/cost_droprate_' + dropou_rate + '_' + str(source) + '_droppos_' + dropout_pos + '_s250_n50/' + str(meta) + '.json') as f:
            # with open('./02.12/r50_retina_consistency_no_bias/cost_droprate_' + dropou_rate + '_' + str(source) + '_droppos_' + dropout_pos + '_s250_n50/' + str(meta) + '.json') as f2:
                data = json.load(f) 
                # data2 = json.load(f2) 
                X.append(data['0'][0][0]*100) # mAP
                # y.append(-data['0'][2][0])
                ...
                # y.append(data['0'][8][0]+data['0'][3][0])
                # y.append(data['0'][8][0]+data['0'][9][0])
                # y.append(1/data['0'][3][0])
                # y.append(1/data['0'][9][0])
                # y.append(data['0'][8][0])
                # y.append(data['0'][8][0])
                # if np.isnan(data['0'][8][0]):
                #     print(source)
                #     print(meta)
                #     print(data['0'][8][0])
                ...
                #     X.append(data['0'][0][0]*100) # mAP
                #     y.append(data['0'][8][0])
                # y.append(data2['0'][3][0]/data['0'][13][0])    
                # y.append(data2['0'][11][0])
                # y.append(data2['0'][12][0]/data['0'][7][0])  # count5 : 9,10임/ count6:9-12
            # y.append(1/data['0'][6][0])
            # y.append(data2['0'][6][0]/data['0'][9][0]/-data['0'][2][0])  # res_resize0.7/0.8/0.9는 idx=9   # 이거 좋음 
            # y.append(1/(data2['0'][6][0]/data['0'][3][0]))
            # y.append(-data['0'][2][0]*(data['0'][3][0]/data2['0'][6][0]))
        # if np.isnan(data['0'][10][0]) :
        #     print(source)
        #     print(meta)
...
f.savefig('./figs_1014/correlation_mAP_bos.pdf', format='pdf')
