...
try:
    os.makedirs('./data_inc_pedestrian/citypersons/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data_pedestrian/citypersons"
IMAGE_DIR = "./data_pedestrian/citypersons"
TARGET_DIR = "./data_inc_pedestrian/citypersons/meta"
num_meta_dataset = 50
