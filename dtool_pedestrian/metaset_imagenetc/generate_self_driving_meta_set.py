...
try:
    os.makedirs('./data_inc_pedestrian/self_driving/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data_pedestrian/self_driving"
IMAGE_DIR = "./data_pedestrian/self_driving"
TARGET_DIR = "./data_inc_pedestrian/self_driving/meta"
num_meta_dataset = 50
...
print("person annotation", len(new_dict['annotations']))
print("person img", len(new_dict['images']))
