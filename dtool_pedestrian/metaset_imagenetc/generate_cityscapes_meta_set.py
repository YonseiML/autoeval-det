...
try:
    os.makedirs('./data_inc_pedestrian/cityscapes/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data_pedestrian/cityscapes"
IMAGE_DIR = "./data_pedestrian/cityscapes"
TARGET_DIR = "./data_inc_pedestrian/cityscapes/meta"
num_meta_dataset = 50
