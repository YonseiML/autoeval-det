...
try:
    os.makedirs('./data_inc_pedestrian/caltech/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data_pedestrian/caltech"
IMAGE_DIR = "./data_pedestrian/caltech"
TARGET_DIR = "./data_inc_pedestrian/caltech/meta"
num_meta_dataset = 50
