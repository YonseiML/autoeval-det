...
try:
    os.makedirs('./data_inc_pedestrian/crowdhuman/meta')
except:
    print('Alread has this path')

ROOT_DIR = "./data_pedestrian/crowdhuman"
IMAGE_DIR = "./data_pedestrian/crowdhuman"
TARGET_DIR = "./data_inc_pedestrian/crowdhuman/meta"
num_meta_dataset = 50
